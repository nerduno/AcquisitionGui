...
%version 1.0001
figure(h_t);
global cutoff  cutoff_value  axis_x1 axis_x2 axis_y1 axis_y2 add_record figure_table file_name bgcolor im_z fill_box save_location
index_color_table=0;
...
if isempty(x);
    ...
    fill_box=0;
        ...
        ScreenSize=get(0,'ScreenSize');
    %Color of line - ploting the features
...
if ~isempty(h)
    ...
    uicontrol('Style','pushbutton',...
        'Position',adj_position([30 141 20 13]),...
        'Interruptible','off',...
        'CData',help_sd,...
    ...
    save_image = imresiz(save_image,[size(save_image,1)*ScreenSize(4)/768 size(save_image,2)*ScreenSize(3)/1024]);
         ...
         uicontrol('Style','pushbutton',...
        'Position',adj_position([132 183 16 15]),...
        'Interruptible','off',...
        'BusyAction','cancel',...
...
if 0
    ...
    uicontrol('Style','pushbutton',...
        'String','Axis',...
        'Position',adj_position([169 183 44 15]),...
        'Interruptible','off',...
        'BusyAction','cancel',...
        'BackgroundColor',bgcolor,...
    ...
    uicontrol('Style','pushbutton',...
        'Position',adj_position([177 183 30 12]),...
        'Interruptible','off',...
...
%            'String','Align',...
    ...
    uicontrol('Style','pushbutton',...
        'Position',adj_position([237 183 15 15]),...
        'CData',P_song_image,...
        'Interruptible','off',...
 ...
 %      'String','P',...
    ...
    uicontrol('Style','pushbutton',...
        'Position',adj_position([32 183 15 15]),...
        'Interruptible','off',...
        'BusyAction','cancel',...
    ...
    re_open_song_image = imresiz(re_open_song_image,[size(re_open_song_image,1)*ScreenSize(4)/768 size(re_open_song_image,2)*ScreenSize(3)/1024]);
        ...
        uicontrol('Style','pushbutton',...
        'Position',adj_position([82 182 18 15]),...
        'Interruptible','off',...
...
defaultanswer={num2str(param.window/44.1),num2str(param.winstep/44.1),num2str(param.spectrum_range*fs/param.window/2),num2str(param.min_freq_winer_ampl/param.pad*fs),num2str(param.max_freq_winer_ampl/param.pad*fs),num2str(param.up_pitch),num2str(param.low_pitch),num2str(param.pitch_HoP),num2str(param.gdn_HoP),num2str(param.up_wiener),param.pitch_averaging,'Off','change'};
...
%                          plot_function(take_off)=[];
                          ...
                          if features_idn(index).position==20/768*ScreenSize(4); 
                            [param]=Parameters;
