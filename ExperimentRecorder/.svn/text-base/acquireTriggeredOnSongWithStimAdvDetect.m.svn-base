function acquireTriggeredOnSongWithStimAdvDetect(exper, stimChan)
...
windowLength = round((actInSampleRate * .5) / (windowSize-windowOverlap)); %song average .9 seconds in length
        ...
        if(~daq_isRecording(exper.audioCh))
            ...
            if(toc < .9)
                ...
                elseif(char == 'r' | char == 't')
                    ...
                    recSampNum = daq_getCurrSampNum - 1;
